...
var _BlockchainWrapper = _interopRequireDefault(require("./Managers/BlockchainWrapper.js"));

var _EncryptionWrapper = _interopRequireDefault(require("./Managers/EncryptionWrapper.js"));

var _IPFSWrapper = _interopRequireDefault(require("./Managers/IPFSWrapper.js"));

var _DropUpload = _interopRequireDefault(require("./Commands/DropUpload.js"));

var _DropEdit = _interopRequireDefault(require("./Commands/DropEdit.js"));

var _VerifyFileCommand = _interopRequireDefault(require("./Commands/VerifyFileCommand.js"));

var _DownloadFileCommand = _interopRequireDefault(require("./Commands/DownloadFileCommand.js"));

var _ShareFileCommand = _interopRequireDefault(require("./Commands/ShareFileCommand.js"));

var _UpdatePermissionsCommand = _interopRequireDefault(require("./Commands/UpdatePermissionsCommand.js"));

var _DeleteFileCommand = _interopRequireDefault(require("./Commands/DeleteFileCommand.js"));
...
function () {
  ...
  _createClass(FileManagerFacade, [{
      ...
      return regeneratorRuntime.async(function downloadFile$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              downloadCommand = new _DownloadFileCommand["default"](this.selectedUser.account, selectedFile, this.getFileFromIPFS.bind(this), this.getEncSymmetricKeyFileUser.bind(this), this.decryptFileWithSymmetricKey.bind(this), this.downloadFileAudit.bind(this));
              _context3.next = 3;
      ...
      return regeneratorRuntime.async(function deleteFile$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              deleteCommand = new _DeleteFileCommand["default"](selectedFile, handleFileDeleted, uploadedFiles, this.deactivateFile.bind(this));
              _context4.next = 3;
    ...
    value: function shareFileCommand(selectedFile, permissions, accountUserToShareFileWith) {
      var shareCommand;
      return regeneratorRuntime.async(function shareFileCommand$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              shareCommand = new _ShareFileCommand["default"](selectedFile, permissions, accountUserToShareFileWith, this.verifyUserAssociatedWithFile.bind(this), this.getAllEncSymmetricKeyFileUser.bind(this), this.decryptSymmetricKeys.bind(this), this.getPubKeyUser.bind(this), this.encryptSymmetricKeys.bind(this), this.fileShare.bind(this), this.selectedUser.account);
              _context5.next = 3;
    ...
    value: function updateUserFilePermissionsCommand(selectedFile, permissions, accountUserToShareFileWith) {
      var updatePermissionsCommand;
      return regeneratorRuntime.async(function updateUserFilePermissionsCommand$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              updatePermissionsCommand = new _UpdatePermissionsCommand["default"](selectedFile, permissions, accountUserToShareFileWith, this.verifyUserAssociatedWithFile.bind(this), this.updateUserFilePermissions.bind(this), this.getPermissionsOverFile.bind(this), this.removeUserFileAssociation.bind(this));
              _context6.next = 3;
      ...
      return regeneratorRuntime.async(function verifyFile$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              verifyFileCommand = new _VerifyFileCommand["default"](fileAsBuffer, this.generateHash256.bind(this), this.verifyValidFile.bind(this), this.recordFileVerification.bind(this), this.selectedUser.account);
              _context7.next = 3;
    ...
    key: "deactivateFile",
    value: function deactivateFile(fileIpfsCid) {
      return regeneratorRuntime.async(function deactivateFile$(_context25) {
        while (1) {
          switch (_context25.prev = _context25.next) {
            case 0:
              _context25.next = 2;
              return regeneratorRuntime.awrap(_BlockchainWrapper["default"].deactivateFile(this.accessControlContract, fileIpfsCid, this.selectedUser.account));
    ...
    key: "getUsersAssociatedWithFile",
    value: function getUsersAssociatedWithFile(fileIpfsCID) {
      return regeneratorRuntime.async(function getUsersAssociatedWithFile$(_context31) {
        while (1) {
          switch (_context31.prev = _context31.next) {
            case 0:
              _context31.next = 2;
              return regeneratorRuntime.awrap(_BlockchainWrapper["default"].getUsersAssociatedWithFile(this.accessControlContract, fileIpfsCID, this.selectedUser.account));
