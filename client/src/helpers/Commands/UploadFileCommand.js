...
class UploadFileCommand extends Command {
    ...
    async execute(){
        ...
        this.fileManager.storeFileBlockchain(fileUploaded, symmetricKey, this.fileManager.selectedUser, this.fileManager.accessManagerContract).then(({receipt, fileUploaded}) => {
