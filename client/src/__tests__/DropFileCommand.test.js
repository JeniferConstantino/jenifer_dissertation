...
describe('DropFileCommand', () => {
    ...
    describe('execute', () => {
        ...
        it("should handle error if it fails in getting the file by it's CID", async function(){
            // Arrange
            dropFileCommand.storeFile = jest.fn().mockReturnValue({ ipfsCID: 'mocked_ipfsCID' });
            fileManager.generateSymmetricKey = jest.fn().mockReturnValue('mockedSymmetricKey');
        ...
        it("shounld handle error if it fails in getting the files' permissions", async function(){
            // Arrange
            dropFileCommand.storeFile = jest.fn().mockReturnValue({ ipfsCID: 'mocked_ipfsCID' });
            fileManager.generateSymmetricKey = jest.fn().mockReturnValue('mockedSymmetricKey');
